...
function process_wrapper_2021_dual(basepath)
...
step2 = 0; %make new class files
    ...
    moviechannels = {'BL3-H', 'GL2-H', 'SSC-A', 'GL1-H'}; %parameter numbers for euk X euk Y synX and SynY polygons if framemaker is general
